...
public class LaunchGame {
    ...
    public static void main(String[] args) {
        ...
        int sel=0;
        while(true){
        System.out.println("Select 1 for Human vs Human --- Select 2 for Human vs Computer");
        sel=sc.nextInt();
        if(sel==1 || sel==2){
            break;
        }else System.out.println("Enter Valid Selection");
        }
        System.out.println("Player 2 Name");
        String p2name=sc.next();
        HumanPlayer p2=new HumanPlayer(p2name,'O');
        AIPlayer p3=new AIPlayer(p2name,'O');
        Player cp;
        cp=p1;
        while(true)
        {
